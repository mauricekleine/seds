...
export const meta: MetaFunction = () => ({
  description:
    "The SEDS school operates out of the SEDS campus and provides a good quality education to children from the surrounding villages. The school follows the Andhra Pradesh State Board prescribed syllabus and uses English for the medium of instruction. In keeping with our environmental focus, hill-top field visits, ecology lessons, stage plays and songs with a conservation theme all an important part of the coursework.",
  title: "SEDS | Children's education",
});
...
const Education = () => (
  ...
  >
    ...
    <p>
      ...
      A minimum of 6 month's commitment is required for a teaching internship at
