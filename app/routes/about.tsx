...
const About = () => (
  ...
  >
    <p>
      ...
      <Link to="/natural-resource-management">
        watershed management, reforestation
      </Link>

      <span>, </span>

      <Link to="/clean-development-mechanism">clean development mechanism</Link>

      <span>, </span>

      <Link to="/low-carbon-farming">low carbon farming</Link>

      <span>
        , rural health, vocational training, village self-help groups, and{" "}
      </span>

      <Link to="/education">children&apos;s education</Link>
